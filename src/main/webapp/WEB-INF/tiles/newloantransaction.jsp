...
<sf:form id="loan" method="post" action="/basic/addloan" modelAttribute="transaction">
	<table class="fancy-table tableshadow">
		<tr>
			<td colspan="2"><sf:input id="autocomplete" class="fancy" path="payment_name" size="55" placeholder="Enter Lending Institution" /></td>
		</tr>
		<tr>
			<td><sf:errors path="payment_name" class="error" />
		</tr>
		<tr>
			<td><b>Amount of Loan:</b><br> <sf:input class="fancy" id="total_due" path="amount" type="number"
