...
<sf:form id="vendor" method="post" action="/basic/addtransaction" modelAttribute="transaction">
	<table class="fancy-table tableshadow">
		...
		<tr>
			...
			<sf:input class="fancy" path="down" id="down_payment" type="number" step=".01" value="0" onchange="eachPayment()"/></td>
			<td><b>Interest:</b><br>
			<sf:input class="fancy" path="interest" id="interest" type="number" step=".01" value="0" onchange="eachPayment()"/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<sf:input class="fancy" id="num_payments" path="num_payments" type="number" step="1" value="0" onchange="eachPayment()"/></td>
			<td><b>Each Payment:</b><br>
			<sf:input class="fancy" id="each_payment" path="each_payment" type="number" step=".01" value="0" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<sf:input class="fancy" path="start" type="date" /></td>
			<td><b>Schedule:</b><br>
				<sf:select path="schedule" class="fancy">
					<sf:option value="">---Select---</sf:option>
