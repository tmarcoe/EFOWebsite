...
<sf:form id="mpProduct" method="post" action="/user/addregistry" modelAttribute="marketPlaceProduct">>
<table class="fancy-table tableshadow">
		<tr>
			<td><sf:input class="fancy" path="product_name" placeholder="Product Name" /></td>
			<td><sf:input class="fancy" path="product_price" type="number" step=".01" placeholder="Asking Price" /></td>
			<td><sf:input class="fancy" path="version" placeholder="Version (xx.xx.xx)" />
		</tr>
		<tr>
