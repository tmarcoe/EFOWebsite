...
<sf:form id="prd" method="post" action="/admin/updatescproduct" modelAttribute="product">
	<table class="fancy-table tableshadow">
		<tr>
			<td colspan="2"><sf:input class="fancy" path="product_name" placeholder="Product Name" size="55"/></td>
		</tr>
		<tr>
			<td><sf:input class="fancy" path="product_id" readonly="true" /> </td>
		...
		<tr>
			<td><sf:button class="fancy-button" type="submit" ><b>Update Product</b></sf:button></td>
