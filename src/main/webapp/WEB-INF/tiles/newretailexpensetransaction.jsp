...
<sf:form id="orderRetail" method="post" action="/basic/addorderretail" modelAttribute="transaction">
	<table class="fancy-table tableshadow">
		...
		<tr>
			<td><b>Amount of Order:</b><br> <sf:input class="fancy" id="total_due" path="amount" type="number"
