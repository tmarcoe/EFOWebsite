...
<sf:form id="postblog" method="post" action="/admin/addblog" modelAttribute="blog" enctype="multipart/form-data">
	<table class="fancy-table tableshadow" style="background-color: #ffeee6;" >
		...
		<tr>
			<td><sf:button class="fancy-button" type="button" onclick="submitForm()" ><b>Submit</b></sf:button></td>
			<td><sf:button class="fancy-button" type="button" onclick="window.location.href='/index/viewblog'" ><b>Cancel</b></sf:button>
		</tr>
	</table>
	<sf:hidden path="id"/>
</sf:form>
	<div id="plsWait" class="modal">
		<div class="modal-content small-modal fancy" >
			<h2>Please Wait</h2>
			<img alt="Spinner" src="<c:url value='/images/spinner.gif'/>">	
		</div>
	</div>
