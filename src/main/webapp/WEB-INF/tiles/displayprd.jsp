		...
		<div class="modal-content medium-modal fancy" style="border-style: solid; border-width: 2px; border-color: black;">
			<table class="tableview tableheading rjthird rjfourth rjfifth rjsixth" style="margin-left: auto; margin-right: auto; width: 100%">
				...
				<tfoot class="tablefooter" >
					...
					<tr>
						<td colspan="4"><button class="fancy-button" type="button" onclick="window.location.href='#'"><b>Check Out</b></button></td>
						<td colspan="2"><button class="fancy-button" type="button" onclick="$('#shoppingCart').hide()"><b>Continue Shopping</b></button></td>
					</tr>
				</tfoot>
			</table>
